...
<html lang="en">
            ...
            <div class="container-fluid bg-dark py-5" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <a href="" class="h5 text-white">Admin Login Page</a>
                    </div>
                </div>
            </div>
        </div>
 ...
 <%
        ...
        <script>alert('Incorrect Password or Authentication Failed');</script>  
        <%}
        %>
        <!-- Contact Start -->
        <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                    <h5 class="fw-bold text-primary text-uppercase">Administrator</h5>
                </div>
                <div class="row g-5">
                    <center><div class="col-md-6" data-wow-delay="0.3s">
                            <form  action="AdminLog" method="post">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <input type="text" class="form-control border-primary   bg-light px-4" name="name" placeholder="Name" style="height: 55px;">
                                    </div>
                                    <div class="col-12">
                                        <input type="password" class="form-control border-primary  bg-light px-4"name="pass" placeholder="Password" style="height: 55px;">
                                    </div>
                                    <center>
                                        <div class="col-5">
