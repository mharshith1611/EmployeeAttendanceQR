            ...
            <div class="container-fluid bg-dark py-5" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <a href="" class="h5 text-white">Calculate Present Days</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                    <h5 class="fw-bold text-primary text-uppercase">Calculate Present Days</h5>
                </div>
                <div class="row g-5">
                    <center><form  action="calculatePresentDays.jsp" method="post" >
                            <fieldset class="row-fluid">
                                <div class="col-md-6">
                                    <label>Employee Id</label>
                                    <select class="form-control border-primary" style="color: black"  required="" name="employeeId">
                                        <%
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input  type="month" name="selectedMonth" id="first_name" class="form-control  border-primary"  style="color: black" style="color: black" required="">
                                </div>
                                
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center" style="margin-top: 30px">
                                    <button type="submit" value="SEND" id="submit" class="btn btn-primary btn-radius btn-brd grd1 btn-block">Submit</button>
                                </div>
                            </fieldset>
                        </form></center>
                </div>
