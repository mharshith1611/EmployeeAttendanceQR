            ...
            <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="EmpAttendanceLogs.jsp" class="nav-item nav-link active">Attendance Logs</a>
            ...
            <div class="container-fluid bg-dark py-5" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <a href="" class="h5 text-white">Attendance Logs</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5">
                    <table id="naresh" style="margin-left: -50px;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from attendance where employee_id='"+empid+"'");
                                        while (rs.next()) {
                                %>
                                <tr>
