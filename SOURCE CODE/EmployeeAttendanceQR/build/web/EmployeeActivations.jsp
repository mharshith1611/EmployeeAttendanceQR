            ...
            <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="EmployeeActivations.jsp" class="nav-item nav-link active">Employee Activations</a>
            ...
            <div class="container-fluid bg-dark py-5" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <a href="" class="h5 text-white">Employee Activations</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                    <h5 class="fw-bold text-primary text-uppercase">Employee Activations</h5>
                </div>
                <div class="row g-5">
                    <table id="naresh" style="margin-left: -50px;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from emp_details where estatus='Waiting'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td ><a href="EmpApprove?empid=<%=rs.getString("empid")%>&email=<%=rs.getString("email")%>"  class="btn btn-success" style="color: white">Approve</a>&nbsp;
                                        <a href="EmpReject?eid=<%=rs.getString("id")%>"   class="btn btn-danger" style="color: white">&nbsp;Reject</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
