...
%>
        <script>alert('Your attendance has been Already registered');</script>  
        <%}
        %>
        <%
            ...
            <div class="container-fluid bg-dark py-5" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <a href="" class="h5 text-white">Employee Login Page</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5">
                    <center>
                            ...
                            <div class="col-md-6" data-wow-delay="0.3s">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <input type="email" class="form-control  border-primary  bg-light px-4" name="email" placeholder="Email" style="height: 55px;">
                                    </div>
                                    <div class="col-12">
                                        <input type="password" class="form-control  border-primary bg-light px-4" name="password" placeholder="Password" style="height: 55px;">
                                    </div>
                                    <center>
                                        <div class="col-5">
